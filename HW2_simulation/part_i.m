...
% Add white noise to the output signal Y at each iteration
for i = 1 : length(U)
    [a(:,i), b(:,i), P, Theta, Phi, K(:,i)] = RecursiveLeastSquares(U(1:i), Y(1:i) + randn(size(Y(1:i))), d, nb, na, P, Theta, Phi, i);
end
%% Plots
